...
class Pr_11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Robinder", 18, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Joginder", 19, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Bobinder", 20, 'M');
